...
template void PathCPURenderState::save(LuxOutputArchiveText &ar, const u_int version) const;
template void PathCPURenderState::load(LuxInputArchiveText &ar, const u_int version);
}
